...
const sequelize = new Sequelize((process.env.NODE_ENV === 'production' ? prodConfig : devConfig), { dialect: 'postgres', dialectOptions: { ssl: { require: true, rejectUnauthorized: false } } });
